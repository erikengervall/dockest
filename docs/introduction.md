...
TODO: 2.0.0 branchen bör stänga/referera till issuen angående port setup

TODO: referera till https://docs.docker.com/compose/compose-file/#long-syntax-1, måste ha långa syntaxen, annars no-trabajo
